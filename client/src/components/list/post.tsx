...
import { FaArrowRight, FaComment, FaHeart, FaRegComment, FaRegHeart, FaShare } from "react-icons/fa";
  ...
  return (
    ...
    >
      <div className="flex gap-3">
        <img src={post.author.profilePicture} alt={post.author.username} className="w-10 h-10 rounded-full" />
